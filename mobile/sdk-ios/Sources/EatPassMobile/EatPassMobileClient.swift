...
/// Coupled mint: iOS App Attest + attester + issuer + eat-pass finalize.
public final class EatPassMobileClient: @unchecked Sendable {
    ...
    public func mintAuthorizationHeader() async throws -> MintResult {
        ...
        let bundle = try await IosAppAttest.createBundle(
            service: appAttest,
            keyId: keyId,
