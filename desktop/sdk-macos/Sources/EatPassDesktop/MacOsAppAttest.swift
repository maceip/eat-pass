...
/// macOS App Attest bundle for `--gate macos-app-attest`.
public enum MacOsAppAttest {
    public static func createBundle(
        ...
        guard service.isSupported else {
            throw EatPassError.attestation("App Attest not supported on this Mac")
        }
    ...
    /// Must match `unified_quote::tee::mobile::ios_client_data_hash`.
